  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            In order to interact with this feature, you must first garner an{" "}
            <Link
              target="_blank"
              color="secondary"
          ...
          <DialogContentText sx={{ marginTop: "1rem" }}>
            <span style={{ color: "#dd524c" }}>Warning</span>: This key will be
            stored in the browser&apos;s local storage.
            <br />
            <strong style={{ color: "#dd524c" }}>
              Do not store your key in a public computer
            </strong>{" "}
            and only use in a brower with extensions you trust!
          </DialogContentText>
        </DialogContent>
        <DialogActions>
