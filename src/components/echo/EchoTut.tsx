...
const exampleResponse = [
  {
    ...
    suggestions: [
      ...
      "How does the prompt analysis work?",
      "How does echo help me get better responses?",
      "I want an overview about how it works",
    ],
    adversity: {
      threshold: 0.9,
    ...
    analyzed: {
      weight: 0.9,
      reason:
        "This concise prompt requests help based on a provided subject matter.",
    },
  },
];
    ...
    >
      ...
      <DialogContent>
        <DialogContentText sx={{ margin: "1rem 0" }}>
          Echo is a tool that improves your prompts by suggesting clarifications
          and identifying vague or contradictory parts, ensuring your queries to
          GPT are as clear as possible.
        </DialogContentText>
